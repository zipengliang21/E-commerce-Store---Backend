...
urlpatterns = [
    ...
    path('vendor/orders/<int:vendor_id>/<order_oid>/',
         vendor_views.OrderDetailAPIView.as_view()),
    path('vendor/orders/filter/<int:vendor_id>/',
         vendor_views.FilterOrdersAPIView.as_view()),
    ...
    path('vendor-notifications-unseen/<vendor_id>/',
         vendor_views.NotificationUnSeenListAPIView.as_view()),
    path('vendor-notifications-seen/<vendor_id>/',
         vendor_views.NotificationSeenListAPIView.as_view()),
    path('vendor-notifications-summary/<vendor_id>/',
         vendor_views.NotificationSummaryAPIView.as_view()),
    path('vendor-notifications-mark-as-seen/<vendor_id>/<noti_id>/',
